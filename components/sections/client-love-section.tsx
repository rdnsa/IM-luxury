...
export function ClientLoveSection() {
  return (
    <section className="section-spacing bg-gradient-to-b from-luxury-black to-[#101010]">
      <div className="luxury-container">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {TESTIMONIALS.map((item) => (
            <article key={item.name} className="rounded-3xl border border-white/10 bg-black/45 p-7 shadow-luxury">
